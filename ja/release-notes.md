...
#### 機能追加
* [API]探索APIパラメータの追加
    * useStartDirection:出発地座標基準探索方向指定機能を使用するか
    * パラメータ追加API
        * 経路探索
        * 経路探索の要約
        * 経路予測探索
...
* [API]住所検証APIパラメータ追加
    * posx：X座標
    * posy：Y座標
    * posx, posyを入力すると、入力した座標と近い順に結果がソートされるように改善

### 2022. 07. 26.
#### 機能追加
* [Console]統計ページExcel抽出機能を追加
    * 時間別、日別、月別
